...
describe 'API' do
  ...
  it 'should return data for a specified month' do
    ...
    expect(last_response.body).to include('"072150":{"200809":{"month":"09-2008","high_max_temp":29.0')
  end
  ...
  it 'should restrict data by geographic area"' do
    ...
    expect(last_response.body).to include('"072150":{"200809":{"month":"09-2008","high_max_temp":29.0,"low_min_temp":-2.6}}}')
  end
